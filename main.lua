...
-- Produces adjustor_m, container_m, stabilizer_m
local function mix_design1()
  local design = Design.new()
  local i_adjustor_m = Design.Industry.new(assembly_line_s, adjustor_m)
  local i_container_m = Design.Industry.new(assembly_line_l, container_m)
  local i_stabilizer_m = Design.Industry.new(assembly_line_m, stabilizer_m)
  local i_basic_pipe = Design.Industry.new(metalwork_industry_m, basic_pipe)
  local i_basic_injector = Design.Industry.new(_3d_printer_m, basic_injector)
  local i_polycarbonate_plastic = Design.Industry.new(chemical_industry_m, polycarbonate_plastic)
  local i_basic_screw = Design.Industry.new(metalwork_industry_m, basic_screw)
  ...
  Design.connect(design, c4, i_basic_mobile_panel_m)
  ...
  Design.connect(design, c1, i_adjustor_m)
  Design.connect(design, c1, i_container_m)
  Design.connect(design, c1, i_stabilizer_m)
  Design.connect(design, c1, t0)
  Design.connect(design, c1, t1)
  
  Design.connect(design, i_adjustor_m, c0)
  Design.connect(design, i_container_m, c0)
  Design.connect(design, i_stabilizer_m, c0)
...
dump(Item.production_amount(atmospheric_engine_m, true))
dump(Item.production_amount(transfer_unit, true))
