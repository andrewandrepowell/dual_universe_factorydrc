...
local function industry_design()
  ...
  Design.connect(design, i_uncommon_electronics.container, i_uncommon_screen_xs.industry)
  ...
  Design.connect(design, i_uncommon_casing_xs.container, i_screen_m.industry)
